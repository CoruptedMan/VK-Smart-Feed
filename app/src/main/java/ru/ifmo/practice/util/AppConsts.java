...
public class AppConsts {
    ...
    public static final String REGEX_WEB_LINK_PATTERN = "(^|\\s)(?:https?://)?[a-zA-Z0-9_/\\-\\.]+\\.([A-Za-z/]{2,5})" +
            "[a-zA-Z0-9_/\\&\\?\\=\\-\\.\\~\\%]*";
    public static final String REGEX_EMAIL_PATTERN = "[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)* " +
            "@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+(?:[A-Z]{2}|com|org|net|gov|biz|info|name|aero|biz|info|jobs|museum)\\b";
}
